...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Bipki.Database.Models.BusinessModels.NotificationSubscription", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<Guid>("SubscribentId")
                        .HasColumnType("uuid")
                        .HasColumnName("subscribent_id");

                    b.HasKey("Id");

                    b.HasIndex("SubscribentId");
            ...
            modelBuilder.Entity("Bipki.Database.Models.BusinessModels.NotificationSubscription", b =>
                {
                    b.HasOne("Bipki.Database.Models.UserModels.User", "Subscribent")
                        .WithMany("NotificationSubscriptions")
                        .HasForeignKey("SubscribentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("notification_subscription_subscribent_id_fkey");

                    b.Navigation("Subscribent");
                });
